...
from . import RotatedATSSHead


@ROTATED_HEADS.register_module()
class RotatedATSSRefineHead(RotatedATSSHead):
    ...
    def __init__(self,
        ...
        super(RotatedATSSRefineHead, self).__init__(
    ...
    def loss(self,
        ...
        return super(RotatedATSSRefineHead, self).loss(
